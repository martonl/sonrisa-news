After planning, I had to manually amend the created plan a bit. I have to add the test writing points at the end of each development phases.

After coding styles, I upgraded plan to following new guides (for example minimal API vs controllers)
